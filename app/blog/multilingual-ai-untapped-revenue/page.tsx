...
export default function MultilingualArticle() {
  return (
    <article className="max-w-[720px] mx-auto px-6">
      ...
      <header className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          <span className="badge-purple text-[10px]">Growth Strategy</span>
          <span className="text-sm text-body">9 min read</span>
      ...
      <div className="prose-stripe">
        <h2>The Scale of the Opportunity You&apos;re Missing</h2>
        <p>
          Let&apos;s start with the numbers that frame the opportunity:
        </p>
        <ul>
        ...
        <h2>The Language Barrier in Healthcare & Local Services</h2>
        <p>
          The language barrier in healthcare is particularly acute because
        ...
        <h3>What Happens When You Can&apos;t Communicate</h3>
        <ul>
          <li><strong>Immediate hang-up:</strong> If the caller can&apos;t communicate with your receptionist, they hang up within 15 seconds.</li>
          <li><strong>Reduced trust:</strong> Even if the caller speaks some English, struggling through a conversation about medical procedures in a second language creates anxiety and erodes trust.</li>
          <li><strong>Lower conversion rates:</strong> Practices report 40–60% lower conversion rates from non-English inquiries handled by English-only staff, even with basic translation attempts.</li>
          <li><strong>Negative word-of-mouth:</strong> Tight-knit language communities share experiences quickly. One bad phone experience can cost you dozens of potential clients through community channels.</li>
        </ul>

        <h3>The Traditional Solution: Bilingual Staff</h3>
        <p>
          The conventional approach is to hire bilingual receptionists. But
          this comes with significant limitations:
        </p>
        <ul>
        ...
        <p>
          Modern AI language technology has made a quantum leap from the
          clunky, pre-recorded phrase translation systems of the past.
          Today&apos;s multilingual AI concierge systems operate on a
          fundamentally different model:
        </p>

        <h3>1. Real-Time Language Detection</h3>
        <p>
          Within the first 2–3 seconds of a call, the AI identifies the
          caller&apos;s language with over 97% accuracy. The system
          seamlessly switches its conversational model without asking the
          caller to &ldquo;press 2 for Spanish.&rdquo; The transition is
        ...
        <p>
          ...
          Instead, it generates native-quality responses in the target
          language, understanding cultural nuances, colloquialisms, and
          regional variations.
        </p>

        <h3>3. Full Service Capability</h3>
        <p>
          The multilingual AI handles the same functions as the
          English-language system:
        </p>
        <ul>
          <li>Service and procedure inquiries</li>
          <li>Pricing and financing discussions</li>
          <li>Appointment scheduling and confirmation</li>
          <li>Follow-up and post-appointment communication</li>
        ...
        <p>
          When practices deploy multilingual AI concierge systems, the
          results across consistent patterns:
        </p>
        <ul>
        ...
        <p>
          Here&apos;s the strategic insight most practice owners miss:
        ...
        <p>
          And once a patient finds a provider who communicates in their
          language, their switching cost is enormous. They won&apos;t leave
          for a competitor who can&apos;t.
        </p>

        <h2>Getting Started</h2>
        <p>
          Deploying multilingual AI doesn&apos;t require any changes to your
          current staff or operations. The AI sits alongside your existing
          phone system and handles:
        </p>
        <ol>
          <li>All after-hours calls in any language</li>
          <li>Overflow calls during business hours when staff is busy</li>
          <li>All non-English calls, routed directly to the AI</li>
        </ol>
        <p>
          Setup takes 48 hours. The AI is trained on your specific services,
          pricing, and scheduling availability. And the ROI from expanded
          market capture typically pays for the system within the first month.
        </p>
        ...
        <div className="offer-box mt-10">
          ...
          <p className="text-label text-[15px] leading-relaxed mb-4">
            ...
            real-time and handles service inquiries, pricing, and booking in
            30+ languages. Book a strategy call to see how it works for your
            practice.
          </p>
